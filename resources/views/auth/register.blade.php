            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="rol" class="col-md-4 col-form-label text-md-end">{{ __('Seleccione un rol') }}</label>

                            <div class="col-md-6">
                                <select class="form-control" name="rol" id="rol" value="{{ old('telefono') }}" required autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="id_empresa" class="col-md-4 col-form-label text-md-end">{{ __('Seleccione un rol') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('Confimar Contraseña') }}</label>
